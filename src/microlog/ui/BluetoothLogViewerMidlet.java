...
import microlog.bluetooth.BluetoothMessageReceiver;
import microlog.bluetooth.BluetoothSerialServerThread;
...
public class BluetoothLogViewerMidlet extends MIDlet implements
	...
	/**
	 * Implementation of the <code>BluetoothMessageReceiver</code> interface.
	 * This is called when a Bluetooth message is recieved.
	 */
