...
import microlog.util.properties.DefaultValues;
import microlog.util.properties.PropertyFile;
import microlog.util.properties.PropertySource;
...
public class Properties implements PropertiesGetter {
	...
	final Hashtable properties = new Hashtable(31);
	...
	void initProperties() {
		...
		if (propertyFileName == null) {
			fileProperties = new PropertyFile(MicrologConstants.DEFAULT_PROPERTY_FILE);
		} else {
