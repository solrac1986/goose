...
public class SyslogAppender extends DatagramAppender {
	...
	private static final String DEFAULT_TAG = "microlog";

	private static final int TEN = 10;

	private static final int DEFAULT_MESSAGE_BUFFER_SIZE = 128;
	...
	public SyslogAppender() {
		...
		super.setDatagramSize(DEFAULT_DATAGRAM_SIZE);
		messageStringBuffer = new StringBuffer(DEFAULT_MESSAGE_BUFFER_SIZE);
	...
	public void doLog(String name, long time, Level level, Object message,
		...
		if (logOpen && formatter != null) {
			...
			messageStringBuffer.append(": ");
			messageStringBuffer.append(formatter.format(name, time, level,
					message, t));
	...
	/**
	 * Get the hostname to use for the HOSTNAME field of the syslog message.
	 * 
	 * @return the hostname that is used for the HOSTNAME field.
	 */
